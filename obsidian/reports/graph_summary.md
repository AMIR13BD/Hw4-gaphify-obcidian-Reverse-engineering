...
All links in the current AST-only graph are **EXTRACTED** (20/20). No INFERRED or AMBIGUOUS edges were emitted.
...
- [[nodes/polygons_polygons_polygon|Polygon]] (degree 4)
