...
- **Node id:** `polygons_polygons_calc_polygon_details`
...
- `contains` from [[nodes/polygons_polygons|polygons.py]] (EXTRACTED)

## Outgoing Relations

- `calls` → [[nodes/polygons_polygons_polygon|Polygon]] (EXTRACTED)
